                ...
                <div className="bg-gray-50 border border-gray-300 rounded px-3 py-2 mt-1 text-sm text-gray-800 shadow min-w-[220px]">
                  ...
                  <ul className="list-none mt-1 space-y-1">
                    <li className="flex items-center gap-2">
                      <span className={passwordCriteria.length ? "text-green-600 font-bold" : "text-red-500 font-bold"}>
                        {passwordCriteria.length ? "✔" : "✘"}
                      </span>
                      At least 6 characters
                    </li>
                    <li className="flex items-center gap-2">
                      <span className={passwordCriteria.uppercase ? "text-green-600 font-bold" : "text-red-500 font-bold"}>
                        {passwordCriteria.uppercase ? "✔" : "✘"}
                      </span>
                      1 uppercase letter
                    </li>
                    <li className="flex items-center gap-2">
                      <span className={passwordCriteria.special ? "text-green-600 font-bold" : "text-red-500 font-bold"}>
