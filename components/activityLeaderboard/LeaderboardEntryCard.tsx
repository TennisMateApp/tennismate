...
export default function LeaderboardEntryCard({compact = false}: {compact?: boolean}) {
  const router = useRouter();
  return (
    <button
      type="button"
      onClick={() => router.push("/activity-leaderboard")}
    ...
    >
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="text-sm font-black text-slate-900 sm:text-base">Activity Leaderboard</div>
