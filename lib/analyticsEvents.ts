export const ANALYTICS_EVENTS = {
  ...
  MATCH_DISTANCE_FILTER_CHANGED: "match_distance_filter_changed",
  MATCH_CLUB_FILTER_SELECTED: "match_club_filter_selected",
  MATCH_CLUB_FILTER_CLEARED: "match_club_filter_cleared",
